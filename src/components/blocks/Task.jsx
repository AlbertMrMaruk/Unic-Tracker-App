  ...
  return (
    <div className="flex w-[100%]">
      ...
      <div
        ...
        }  flex align-middle  justify-between ease-in-out duration-300 h-auto ml-[1rem] gap-2 flex-col  md:hidden`}
      >
        <div className=" bg-red-600 flex align-middle text-white rounded-2xl shadow-xl h-[50%]  shadow-[#00000047]">
          <FaTrash
            className={`m-auto   text-3xl cursor-pointer`}
            onClick={deleteTask}
          />
        </div>
        <div className="  bg-[#383a39] text-white rounded-2xl shadow-xl h-[50%] flex align-middle  shadow-[#00000047]">
          <FaEdit
            className={`m-auto   text-3xl cursor-pointer`}
            onClick={() => navigate("/edit-task", { state: { id } })}
          />
        </div>
      </div>
    </div>
